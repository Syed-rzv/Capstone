...
def train_classifier(data_path="C:/Capstone/Data/cleaned_data.csv", model_path="models/classifier_dt.pkl"):
    ...
    clf = Pipeline([
        ...
        ("dt", DecisionTreeClassifier(class_weight="balanced", random_state=42, max_depth=None))
    ])
